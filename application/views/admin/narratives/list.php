<div class="container fixed-margin">
	...
	<?php echo form_open('admin/narratives/bulk'); ?>
		...
		<div class="btn-group big-top-margin float-left left-margin">
			...
			<?php echo form_button(array('name' => 'action', 'value' => 'markNeutral', 'type' => 'submit', 'content' => 'Ambivalent', 'class' => "btn btn-default")); ?>
	...
	<table class="table table-hover table-striped table-multiselect" id="admin-narratives-list">
		<thead>
			<tr>
				...
				<th><a href="<?php echo site_url("admin/narratives/position/".(($sort_order == "desc" && $sort_by == "position") ? "asc" : "desc")."/$offset"); ?>" class="sort-btn<?php echo ($sort_by == "position") ? " active $sort_order" : ""; ?>">Position</a></th>
		...
		<tbody>
			<?php foreach ($narratives as $narrative): ?>
				<tr>
					...
					<td><?php print ($narrative['position'] == 0 ? 'Ambivalent' : ($narrative['position'] == 1 ? 'For' : ($narrative['position'] == 2 ? 'Against' : '(Invalid)'))); ?></td>
